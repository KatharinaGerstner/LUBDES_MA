...
############################################################################
### -04.1. Extract zotero citation data into excel.
### 
### 
############################################################################
...
write.csv(dfData6,"/tmp/ZoteroCitations_missing.csv")
