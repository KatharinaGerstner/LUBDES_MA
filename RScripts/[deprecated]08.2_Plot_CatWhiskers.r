...
CatsWhiskers_plot(data=ES.frame.yield, dataType="model", YieldorRichness = "yield", model=Yield.MA.model[["select"]]$model)
CatsWhiskers_plot(data=ES.frame.richness, dataType="model", YieldorRichness = "richness", model=Richness.MA.model[["select"]]$model)
