...
### Patterns of observed vs imputed standard deviations in relation to the mean
...
Imputation is probably the greatest source of uncertainty we can control for. The mice package creates a set of imputed values by Gibbs sampling. We follow two approaches and compare the results:  
1. calculate the mean across the imputation chains and perform a single analysis  
2. Loop through different imputation chains, repeat the analysis, average resulting model parameters according to Nakagawa & Freckleton (2011)
...
- $R^2_{LMM(c)}$, i.e. the percentage of variance explained by the fixed and random effects.
