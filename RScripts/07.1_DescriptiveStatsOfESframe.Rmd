...
ecoregions@data$BIOME[(ecoregions@data$BIOME %in% c("Mediterranean Forests, Woodlands and Scrub",
...
biome_map <- ggplot() +
     geom_polygon(data = biome_mapdata, aes(x = long, y = lat, group = group, fill = id)) +
     ...
     xlab("") + ylab("") +
     scale_fill_manual(values=c(rgb(255,127,0, max = 255), 
...
save(biome_map, file=path2temp %+% "biome_map.Rdata")
