...
t.test(Log.RR ~ factor(LU.definition.and.ES), data=subset(ES.frame.yield,Product=="timber"))
...
ggsave(p12,file=path2temp %+% "confoundingVariable1.png", width=9,height=5)
